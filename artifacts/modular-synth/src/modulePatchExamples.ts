...
export const MODULE_PATCH_EXAMPLES: Record<string, PatchExample> = {
  ...
  analog_vco: {
    ...
    connections: [
      ...
      { from: 'VCA',     out: 'OUT',    to: 'Output',     in: 'L',     sig: 'audio' },
    ],
  ...
  wavetable_osc: {
    ...
    connections: [
      ...
      { from: 'Reverb',       out: 'OUT',   to: 'Output',        in: 'L',     sig: 'audio' },
    ],
  ...
  noise: {
    ...
    connections: [
      { from: 'Clock Gen', out: 'CLK',   to: 'ADSR',   in: 'GATE',  sig: 'gate'  },
  ...
  vca_expo: {
    ...
    connections: [
      ...
      { from: 'VCA Expo',  out: 'OUT',   to: 'Output',     in: 'L',     sig: 'audio' },
    ],
  ...
  compressor: {
    ...
    modules: ['Drum Machine', 'Synth Bass', 'Compressor', 'Output'],
    connections: [
      { from: 'Drum Machine', out: 'KICK', to: 'Compressor', in: 'SC',  sig: 'audio' },
      { from: 'Synth Bass',   out: 'OUT',  to: 'Compressor', in: 'IN',  sig: 'audio' },
      { from: 'Compressor',   out: 'OUT',  to: 'Output',     in: 'L',   sig: 'audio' },
    ],
  ...
  noise_gate: {
    ...
    connections: [
      ...
      { from: 'Noise Gate', out: 'OPEN', to: 'Output',    in: 'L',     sig: 'audio' },
      { from: 'Noise Gate', out: 'OUT',  to: 'Output',    in: 'L',     sig: 'audio' },
    ],
  ...
  seq_step: {
    ...
    connections: [
      { from: 'Clock Gen', out: 'CLK',   to: 'Step Seq',   in: 'CLK',   sig: 'gate'  },
  ...
  seq_trigger: {
    ...
    connections: [
      { from: 'Clock Gen',  out: 'CLK',  to: 'Trigger Seq',  in: 'CLK',     sig: 'gate'  },
      { from: 'Trigger Seq', out: 'GATE', to: 'Drum Machine', in: 'KICK IN', sig: 'gate'  },
      { from: 'Drum Machine', out: 'MIX', to: 'Output',       in: 'L',       sig: 'audio' },
    ],
  ...
  arpeggiator: {
    ...
    connections: [
      { from: 'Keyboard',   out: 'GATE',  to: 'Arpeggiator', in: 'GATE IN',  sig: 'gate'  },
      { from: 'Keyboard',   out: 'V/OCT', to: 'Arpeggiator', in: 'V/OCT IN', sig: 'cv'    },
  ...
  clock_div: {
    ...
    connections: [
      { from: 'Clock Gen',     out: 'CLK',   to: 'Clock Divider', in: 'CLK',     sig: 'gate'  },
      { from: 'Clock Gen',     out: 'CLK',   to: 'Drum Machine',  in: 'KICK IN', sig: 'gate'  },
      { from: 'Clock Divider', out: 'OUT',   to: 'Drum Machine',  in: 'SNARE IN', sig: 'gate' },
      { from: 'Drum Machine',  out: 'MIX',   to: 'Output',        in: 'L',        sig: 'audio' },
    ],
  ...
  midi_clock_in: {
    ...
    connections: [
      ...
      { from: 'Analog VCO',    out: 'SAW',   to: 'Output',     in: 'L',     sig: 'audio' },
    ],
  ...
  delay_mod: {
    ...
    connections: [
      ...
      { from: 'Delay Mod', out: 'OUT',   to: 'Output',     in: 'L',     sig: 'audio' },
    ],
  ...
  delay_tape: {
    ...
    connections: [
      ...
      { from: 'Tape Delay', out: 'OUT',  to: 'Output',     in: 'L',     sig: 'audio' },
    ],
  ...
  reverb_shimmer: {
    ...
    connections: [
      ...
      { from: 'Shimmer Reverb', out: 'OUT',  to: 'Output',         in: 'L',    sig: 'audio' },
    ],
  ...
  chorus: {
    ...
    connections: [
      ...
      { from: 'Chorus',    out: 'OUT',   to: 'Output',    in: 'L',    sig: 'audio' },
    ],
  ...
  flanger: {
    ...
    connections: [
      ...
      { from: 'Flanger',   out: 'OUT',   to: 'Output',     in: 'L',     sig: 'audio' },
    ],
  ...
  overdrive: {
    ...
    connections: [
      ...
      { from: 'VCF',       out: 'OUT',   to: 'Output',     in: 'L',     sig: 'audio' },
    ],
  ...
  pitch_shift: {
    ...
    connections: [
      ...
      { from: 'Mixer',      out: 'OUT',  to: 'Output',     in: 'L',     sig: 'audio' },
    ],
  ...
  vocoder: {
    ...
    connections: [
      ...
      { from: 'Vocoder',    out: 'OUT', to: 'Output',  in: 'L',   sig: 'audio' },
    ],
  ...
  freeze_proc: {
    ...
    connections: [
      ...
      { from: 'Freeze',    out: 'OUT',   to: 'Output',     in: 'L',     sig: 'audio' },
    ],
  ...
  sampler: {
    ...
    connections: [
      { from: 'Keyboard', out: 'V/OCT', to: 'Sampler', in: 'PITCH', sig: 'cv'    },
  ...
  euclidean_trig: {
    ...
    connections: [
      { from: 'Clock Gen',  out: 'CLK',  to: 'Euclidean',   in: 'CLK',     sig: 'gate'  },
      { from: 'Euclidean',  out: 'GATE', to: 'Drum Machine', in: 'KICK IN', sig: 'gate'  },
      { from: 'Euclidean',  out: 'INV',  to: 'Drum Machine', in: 'HH IN',   sig: 'gate'  },
      { from: 'Drum Machine', out: 'MIX', to: 'Output',      in: 'L',       sig: 'audio' },
    ],
  ...
  drum_machine: {
    ...
    connections: [
      { from: 'Clock Gen',  out: 'CLK',  to: 'Drum Machine', in: 'KICK IN',  sig: 'gate'  },
      { from: 'Clock Gen',  out: '/4',   to: 'Drum Machine', in: 'SNARE IN', sig: 'gate'  },
      { from: 'Euclidean',  out: 'GATE', to: 'Drum Machine', in: 'HH IN',    sig: 'gate'  },
  ...
  poly_step: {
    ...
    connections: [
      { from: 'Clock Gen', out: 'CLK',   to: 'Poly Step',  in: 'CLK',   sig: 'gate'  },
      { from: 'Poly Step', out: 'GATE1', to: 'Analog VCO', in: 'SYNC',  sig: 'gate'  },
      { from: 'Poly Step', out: 'GATE2', to: 'Drum Machine', in: 'KICK IN', sig: 'gate' },
      { from: 'Poly Step', out: 'CV1',   to: 'Analog VCO', in: 'V/OCT', sig: 'cv'    },
      { from: 'Analog VCO', out: 'SAW',  to: 'Output',    in: 'L',     sig: 'audio' },
      { from: 'Drum Machine', out: 'MIX', to: 'Output',   in: 'R',     sig: 'audio' },
    ],
