...
export const MODULE_TYPES: ModuleTypeDef[] = [
  ...
  {
    id: 'poly_step', name: 'POLY STEP', category: 'sequencer', accentColor: '#c084fc', width: 960, height: 560,
    knobs: [
      // Global controls
      { id: 'bpm',      name: 'BPM',   min: 20,  max: 300, default: 120, step: 1 },
      { id: 'swing',    name: 'SWING', min: 0,   max: 0.5, default: 0 },
      ...
      // Track 1 — KICK (16 steps, 4/4 pattern)
      { id: 't1',      name: 'T1 STEPS', min: 0, max: 65535, default: 4369,  step: 1 },
      { id: 't1_acc',  name: 'T1 ACC',   min: 0, max: 65535, default: 257,   step: 1 },
      { id: 't1_len',  name: 'T1 LEN',   min: 0, max: 3,     default: 3,     step: 1 },
      { id: 't1_prob', name: 'T1 PROB',  min: 0, max: 1,     default: 1 },
      { id: 't1_mute', name: 'T1 MUTE',  min: 0, max: 1,     default: 0,     step: 1 },
      { id: 't1_vel',  name: 'T1 VEL',   min: 0, max: 1,     default: 0.85 },
      // Track 2 — SNARE (16 steps, 2+4)
      { id: 't2',      name: 'T2 STEPS', min: 0, max: 65535, default: 4112,  step: 1 },
      { id: 't2_acc',  name: 'T2 ACC',   min: 0, max: 65535, default: 4112,  step: 1 },
      { id: 't2_len',  name: 'T2 LEN',   min: 0, max: 3,     default: 3,     step: 1 },
      { id: 't2_prob', name: 'T2 PROB',  min: 0, max: 1,     default: 1 },
      { id: 't2_mute', name: 'T2 MUTE',  min: 0, max: 1,     default: 0,     step: 1 },
      { id: 't2_vel',  name: 'T2 VEL',   min: 0, max: 1,     default: 0.8 },
      // Track 3 — HH CLOSED (8 steps, every 8th)
      { id: 't3',      name: 'T3 STEPS', min: 0, max: 65535, default: 85,    step: 1 },
      { id: 't3_acc',  name: 'T3 ACC',   min: 0, max: 65535, default: 0,     step: 1 },
      { id: 't3_len',  name: 'T3 LEN',   min: 0, max: 3,     default: 1,     step: 1 },
      { id: 't3_prob', name: 'T3 PROB',  min: 0, max: 1,     default: 1 },
      { id: 't3_mute', name: 'T3 MUTE',  min: 0, max: 1,     default: 0,     step: 1 },
      { id: 't3_vel',  name: 'T3 VEL',   min: 0, max: 1,     default: 0.65 },
      // Track 4 — HH OPEN (8 steps, offbeats)
      { id: 't4',      name: 'T4 STEPS', min: 0, max: 65535, default: 136,   step: 1 },
      { id: 't4_acc',  name: 'T4 ACC',   min: 0, max: 65535, default: 0,     step: 1 },
      { id: 't4_len',  name: 'T4 LEN',   min: 0, max: 3,     default: 1,     step: 1 },
      { id: 't4_prob', name: 'T4 PROB',  min: 0, max: 1,     default: 1 },
      { id: 't4_mute', name: 'T4 MUTE',  min: 0, max: 1,     default: 0,     step: 1 },
      { id: 't4_vel',  name: 'T4 VEL',   min: 0, max: 1,     default: 0.6 },
      // Tracks 5–8 — empty
      { id: 't5',      name: 'T5 STEPS', min: 0, max: 65535, default: 0,     step: 1 },
      { id: 't5_acc',  name: 'T5 ACC',   min: 0, max: 65535, default: 0,     step: 1 },
      { id: 't5_len',  name: 'T5 LEN',   min: 0, max: 3,     default: 1,     step: 1 },
      { id: 't5_prob', name: 'T5 PROB',  min: 0, max: 1,     default: 1 },
      { id: 't5_mute', name: 'T5 MUTE',  min: 0, max: 1,     default: 0,     step: 1 },
      { id: 't5_vel',  name: 'T5 VEL',   min: 0, max: 1,     default: 0.75 },
      { id: 't6',      name: 'T6 STEPS', min: 0, max: 65535, default: 0,     step: 1 },
      { id: 't6_acc',  name: 'T6 ACC',   min: 0, max: 65535, default: 0,     step: 1 },
      { id: 't6_len',  name: 'T6 LEN',   min: 0, max: 3,     default: 1,     step: 1 },
      { id: 't6_prob', name: 'T6 PROB',  min: 0, max: 1,     default: 1 },
      { id: 't6_mute', name: 'T6 MUTE',  min: 0, max: 1,     default: 0,     step: 1 },
      { id: 't6_vel',  name: 'T6 VEL',   min: 0, max: 1,     default: 0.75 },
      { id: 't7',      name: 'T7 STEPS', min: 0, max: 65535, default: 0,     step: 1 },
      { id: 't7_acc',  name: 'T7 ACC',   min: 0, max: 65535, default: 0,     step: 1 },
      { id: 't7_len',  name: 'T7 LEN',   min: 0, max: 3,     default: 1,     step: 1 },
      { id: 't7_prob', name: 'T7 PROB',  min: 0, max: 1,     default: 1 },
      { id: 't7_mute', name: 'T7 MUTE',  min: 0, max: 1,     default: 0,     step: 1 },
      { id: 't7_vel',  name: 'T7 VEL',   min: 0, max: 1,     default: 0.75 },
      { id: 't8',      name: 'T8 STEPS', min: 0, max: 65535, default: 0,     step: 1 },
      { id: 't8_acc',  name: 'T8 ACC',   min: 0, max: 65535, default: 0,     step: 1 },
      { id: 't8_len',  name: 'T8 LEN',   min: 0, max: 3,     default: 1,     step: 1 },
      { id: 't8_prob', name: 'T8 PROB',  min: 0, max: 1,     default: 1 },
      { id: 't8_mute', name: 'T8 MUTE',  min: 0, max: 1,     default: 0,     step: 1 },
      { id: 't8_vel',  name: 'T8 VEL',   min: 0, max: 1,     default: 0.75 },
    ],
    ports: [
      // ── Inputs ──────────────────────────────────────────────────────────────
      ...
      // ── Gate outputs — per track ────────────────────────────────────────────
      { id: 't1_gate', name: 'T1 GT', type: 'gate_out' },
      { id: 't2_gate', name: 'T2 GT', type: 'gate_out' },
      { id: 't3_gate', name: 'T3 GT', type: 'gate_out' },
      { id: 't4_gate', name: 'T4 GT', type: 'gate_out' },
      { id: 't5_gate', name: 'T5 GT', type: 'gate_out' },
      { id: 't6_gate', name: 'T6 GT', type: 'gate_out' },
      { id: 't7_gate', name: 'T7 GT', type: 'gate_out' },
      { id: 't8_gate', name: 'T8 GT', type: 'gate_out' },
      // ── Global gate outputs ─────────────────────────────────────────────────
      { id: 'clk_out',  name: 'CLK',  type: 'gate_out' },
      { id: 'beat_out', name: 'BEAT', type: 'gate_out' },
      { id: 'eoc_out',  name: 'EOC',  type: 'gate_out' },
      // ── Accent outputs — per track ──────────────────────────────────────────
      { id: 't1_acc', name: 'T1 AC', type: 'gate_out' },
      { id: 't2_acc', name: 'T2 AC', type: 'gate_out' },
      { id: 't3_acc', name: 'T3 AC', type: 'gate_out' },
      { id: 't4_acc', name: 'T4 AC', type: 'gate_out' },
      { id: 't5_acc', name: 'T5 AC', type: 'gate_out' },
      { id: 't6_acc', name: 'T6 AC', type: 'gate_out' },
      { id: 't7_acc', name: 'T7 AC', type: 'gate_out' },
      { id: 't8_acc', name: 'T8 AC', type: 'gate_out' },
      // ── Velocity CV outputs — per track ────────────────────────────────────
      { id: 't1_vel', name: 'T1 VL', type: 'cv_out' },
      { id: 't2_vel', name: 'T2 VL', type: 'cv_out' },
      { id: 't3_vel', name: 'T3 VL', type: 'cv_out' },
      { id: 't4_vel', name: 'T4 VL', type: 'cv_out' },
      { id: 't5_vel', name: 'T5 VL', type: 'cv_out' },
      { id: 't6_vel', name: 'T6 VL', type: 'cv_out' },
      { id: 't7_vel', name: 'T7 VL', type: 'cv_out' },
      { id: 't8_vel', name: 'T8 VL', type: 'cv_out' },
      // ── End-of-cycle gate outputs — per track ───────────────────────────────
      { id: 't1_eoc', name: 'T1 EC', type: 'gate_out' },
      { id: 't2_eoc', name: 'T2 EC', type: 'gate_out' },
      { id: 't3_eoc', name: 'T3 EC', type: 'gate_out' },
      { id: 't4_eoc', name: 'T4 EC', type: 'gate_out' },
      { id: 't5_eoc', name: 'T5 EC', type: 'gate_out' },
      { id: 't6_eoc', name: 'T6 EC', type: 'gate_out' },
      { id: 't7_eoc', name: 'T7 EC', type: 'gate_out' },
      { id: 't8_eoc', name: 'T8 EC', type: 'gate_out' },
      // ── Global CV outputs ───────────────────────────────────────────────────
