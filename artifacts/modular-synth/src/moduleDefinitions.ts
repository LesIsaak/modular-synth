...
export const MODULE_TYPES: ModuleTypeDef[] = [
  ...
  // ─── Utility / I/O ─────────────────────────────────────────────────
  {
    id: 'mixer', name: 'Mixer', category: 'utility', accentColor: UTL, width: 330,
    knobs: [
      { id: 'ch1',     name: 'VOL', min: 0,   max: 1,  default: 0.8 },
      { id: 'ch1_hi',  name: 'HI',  min: -12, max: 12, default: 0 },
      { id: 'ch1_mid', name: 'MID', min: -12, max: 12, default: 0 },
      { id: 'ch1_lo',  name: 'LO',  min: -12, max: 12, default: 0 },
      { id: 'ch2',     name: 'VOL', min: 0,   max: 1,  default: 0.8 },
      { id: 'ch2_hi',  name: 'HI',  min: -12, max: 12, default: 0 },
      { id: 'ch2_mid', name: 'MID', min: -12, max: 12, default: 0 },
      { id: 'ch2_lo',  name: 'LO',  min: -12, max: 12, default: 0 },
      { id: 'ch3',     name: 'VOL', min: 0,   max: 1,  default: 0.8 },
      { id: 'ch3_hi',  name: 'HI',  min: -12, max: 12, default: 0 },
      { id: 'ch3_mid', name: 'MID', min: -12, max: 12, default: 0 },
      { id: 'ch3_lo',  name: 'LO',  min: -12, max: 12, default: 0 },
      { id: 'ch4',     name: 'VOL', min: 0,   max: 1,  default: 0.8 },
      { id: 'ch4_hi',  name: 'HI',  min: -12, max: 12, default: 0 },
      { id: 'ch4_mid', name: 'MID', min: -12, max: 12, default: 0 },
      { id: 'ch4_lo',  name: 'LO',  min: -12, max: 12, default: 0 },
      { id: 'ch5',     name: 'VOL', min: 0,   max: 1,  default: 0.8 },
      { id: 'ch5_hi',  name: 'HI',  min: -12, max: 12, default: 0 },
      { id: 'ch5_mid', name: 'MID', min: -12, max: 12, default: 0 },
      { id: 'ch5_lo',  name: 'LO',  min: -12, max: 12, default: 0 },
      { id: 'ch6',     name: 'VOL', min: 0,   max: 1,  default: 0.8 },
      { id: 'ch6_hi',  name: 'HI',  min: -12, max: 12, default: 0 },
      { id: 'ch6_mid', name: 'MID', min: -12, max: 12, default: 0 },
      { id: 'ch6_lo',  name: 'LO',  min: -12, max: 12, default: 0 },
    ],
    ports: [
  ...
  // ─── Poly Step Drum Sequencer ─────────────────────────────────────────────────
  {
    ...
    knobs: [
      ...
      { id: 'global_len', name: 'LENGTH', min: 0,   max: 4,     default: 3, step: 1 },
  ...
  // ── Synths ──────────────────────────────────────────────────────────────
  {
    ...
    ports: [
      { id: 'gate_in',     name: 'GATE',   type: 'gate_in'  },
      { id: 'sync_in',     name: 'SYNC',   type: 'gate_in'  },
      { id: 'rec_in',      name: 'REC',    type: 'audio_in' },
      { id: 'voct',        name: 'V/OCT',  type: 'cv_in'    },
      { id: 'pos_cv',      name: 'POS',    type: 'cv_in'    },
